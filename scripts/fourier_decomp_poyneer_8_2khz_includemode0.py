...
data_file = '/data/users/jumfowle/outputs/turbulence_poyneer_8_franken_AOres=144_2khz_finite.fits'
...
modes = decompose_images(i0, j0, m0, n0, resolution, t_frames, data, A, save='modes=48_frames=30000_poyneer_8_franken_2khz_include_mode0_finite.fits')
