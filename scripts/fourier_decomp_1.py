...
data = fits.getdata('/data/users/jumfowle/outputs/turbulence_1_8_franken_AO.fits')
...
modes = decompose_images(i0, j0, m0, n0, resolution, t_frames, data, A, save='/data/users/jumfowle/outputs/modes=48_frames=60000_1_franken.fits')
