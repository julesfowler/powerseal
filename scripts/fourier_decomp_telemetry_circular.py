...
t_frames = 110000
training, future, future_integrator_residuals = read_data(t_frames, 10000)
#training = training.reshape(357, t_frames)
#future = future.reshape(357, 10000)
...
resolution = 22
pupil_grid = make_pupil_grid(21, 8)
...
_, A = build_complex_basis(i0, j0, m0, n0, aperture_bools, n_ap=357)
modes = decompose_images(i0, j0, m0, n0, resolution, 10000, future, A,
        aperture_bools, save='future_modes=22_frames=10000_telemetry_circular.fits')
modes = decompose_images(i0, j0, m0, n0, resolution, t_frames, training, A,
        aperture_bools, save='training_modes=22_frames=10000_telemetry_circular.fits')
